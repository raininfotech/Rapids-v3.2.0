...
def setup_repos():
    ...
    if not os.path.isdir('rapids-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/rapids-Project/rapids-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('rapids'):
        subprocess.check_call(['git', 'clone', 'https://github.com/rapids-Project/rapids.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/rapids-Project/rapids', help='Specify the URL of the repository. Default is %(default)s')
