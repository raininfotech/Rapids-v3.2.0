...
memory available when compiling Rapids. On systems with less, gcc can be
...
To build Rapids without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
When the intention is to run only a P2P node without a wallet, Rapids may be compiled in
