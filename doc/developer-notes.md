...
- [Development guidelines](#development-guidelines)
    - [General Rapids](#general-rapids-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Rapids uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Rapids is a multi-threaded application, and deadlocks or other
...
([`valgrind.supp`](https://github.com/rapids-project/rapids/blob/master/contrib/valgrind.supp))
...
However, in open source software such as Rapids, where everyone uses
...
pay attention to for reviewers of Rapids code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Rapids uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Rapids so that they can be integrated
