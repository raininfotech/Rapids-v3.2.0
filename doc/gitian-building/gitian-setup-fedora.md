...
The build script we'll be using is contained in the Rapids github repository ([contrib/gitian-build.py](https://github.com/rapids-project/rapids/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Rapids repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Rapids-Project/Rapids/master/contrib/gitian-build.py
