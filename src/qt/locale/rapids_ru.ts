...
<context>
    ...
    <message>
        ...
        <translation>Вместо того, чтобы делиться только адресом Rapids, вы можете создать запрос на оплату, связывая больше информации</translation>
    </message>
    <message>
...
Using this mechanism you can share your keys without middle-man risk, only need to store your passphrase safely</source>
        <translation>Зашифруйте свои адреса Rapids (фактически, пару ключей), используя шифрование BIP38.
