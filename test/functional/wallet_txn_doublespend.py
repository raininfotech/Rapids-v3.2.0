...
class TxnMallTest(RapidsTestFramework):
    ...
    def run_test(self):
        ...
        if self.options.mine_block:
            assert_equal(tx1["rpdconfirmations"], 1)
            assert_equal(tx2["rpdconfirmations"], 1)
            # Node1's balance should be both transaction amounts:
            assert_equal(self.nodes[1].getbalance(), starting_balance - tx1["amount"] - tx2["amount"])
        else:
            assert_equal(tx1["rpdconfirmations"], 0)
            assert_equal(tx2["rpdconfirmations"], 0)
        ...
        assert_equal(tx1["rpdconfirmations"], -2)
        assert_equal(tx2["rpdconfirmations"], -2)
